  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="active hover-underline-animation" href="index.php">Home</a></li>
          <li><a class="hover-underline-animation" href="about.php">About</a></li>
          <li><a class="hover-underline-animation" href="testimonials.html">Testimonials</a></li>
          <li><a class="hover-underline-animation" href="pricing.html">Youtube</a></li>
          <li class="dropdown"><a href="#"><span>Portfolio</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="interior.php">Interior</a></li>
              <li><a href="exterior.php">Exterior.php</a></li>
              <li><a href="kitchen.php">Kitchen.php</a></li>
            </ul>
          </li>
