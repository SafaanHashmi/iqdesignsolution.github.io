  ...
  <main id="main">
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
		...
		<div class="section-title" data-aos="fade-up" style="padding-bottom: 5px;">
			<h2 style="text-align: left;"> <strong><i class="ri-star-line"></i> Bedroom </strong> Degisn 2 </h2>
        </div>
        <div class="row portfolio-container" data-aos="fade-up">
          <div class="col-lg-4 col-md-6 portfolio-item">
		...
		<div class="section-title" data-aos="fade-up" style="padding-bottom: 5px;">
			<h2 style="text-align: left;"> <strong><i class="ri-star-line"></i> Bedroom </strong> Degisn 3 </h2>
        </div>
        <div class="row portfolio-container" data-aos="fade-up">
          <div class="col-lg-4 col-md-6 portfolio-item">
